...
- (void)show
{
    ...
    // Attached to the top most window (make sure we are using the right orientation):
        ...
        // edit: don't need to rotate view in ios8 or above
...
- (CGSize)countScreenSize
{
    ...
    // edit: don't need to swap width/height in ios8 or above
    if ([[[UIDevice currentDevice]systemVersion] floatValue] <8.0) {
        UIInterfaceOrientation interfaceOrientation = [[UIApplication sharedApplication] statusBarOrientation];
...
- (void)deviceOrientationDidChange: (NSNotification *)notification
{
    ...
    // edit: change orientation when device version under 8.0
    if ([[[UIDevice currentDevice]systemVersion]floatValue] < 8.0) {
        UIInterfaceOrientation interfaceOrientation = [[UIApplication sharedApplication] statusBarOrientation];
    ...
    // edit: change orientation when device version equal or above 8.0
    else {
        [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
                         animations:^{
                             self.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
...
- (void)keyboardWillShow: (NSNotification *)notification
{
    ...
    UIInterfaceOrientation interfaceOrientation = [[UIApplication sharedApplication] statusBarOrientation];
    // edit: swap height/width when ios version is under 8.0
    if ([[[UIDevice currentDevice] systemVersion] floatValue] < 8.0) {
        if (UIInterfaceOrientationIsLandscape(interfaceOrientation)) {
